                      ...
                      <table id="tabledesignation" class="table">
                        ...
                        <tbody>
                          ...
                          <tr class="text-center">
                            ...
                            <td><?php echo $value->designationdecs; ?></td>
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <button class="btn btn-link" onclick="edtItem('<?php echo $value->iddesignation; ?>');"><i class="fa fa-pencil"></i></button>
                                  <button class="btn btn-link" onclick="delItem('<?php echo $value->iddesignation; ?>');"><i class="fa fa-trash-o"></i></button>
                                </div>
                              </div>
                            </td>
                          </tr>
...
<?php
  ...
  $this->load->view("hrm/js-crud/crud-designation");
?>
