                      ...
                      <table id="tabledepartment" class="table">
                        ...
                        <tbody>
                          ...
                          <tr class="text-center">
                            ...
                            <td><?php echo $value->departmentlead; ?></td>
                            <td><?php
                            $sql = $this->db->query("select count(department) as dep from employee where department='$value->iddepartment'")->row();
                            echo $sql->dep." Employee[s]";
                             ?></td>
                            <td><button type="button" class="btn btn-outline-info" onclick="viewdep('<?php echo $value->departmenttitle; ?>')">view</button></td>
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <button class="btn btn-link" onclick="edtItem('<?php echo $value->iddepartment; ?>');"><i class="fa fa-pencil"></i></button>
                                  <button class="btn btn-link" onclick="delItem('<?php echo $value->iddepartment; ?>');"><i class="fa fa-trash-o"></i></button>
