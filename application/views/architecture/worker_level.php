      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row mb-4">
            <div class="col-12 d-flex align-items-center justify-content-between">
              <h4 class="page-title">Worker Level</h4>
                  ...
                  <div class="row">
                    <div class="col-12 table-responsive">
                      <table id="tabledepartment" class="table">
                        ...
                        <tbody>
                          <?php $i=1; foreach($wage as $row){ ?>
                            <tr class="text-center">
                              <td><?php echo $row->workername; ?></td>
                              <!-- <td><?php echo $row->workerwage; ?></td> -->
          ...
          <div class="modal-dialog" role="document" style="margin-top: 15px;margin-bottom: 0">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formStaffLabel">Create Worker Level</h5>
              ...
              <div class="modal-footer">
                <button type="submit" class="btn btn-success" id="btnok">Add Worker Level</button>
        ...
        <div class="modal fade" id="editform" tabindex="-1" role="dialog" aria-labelledby="formStaffLabel" data-backdrop="static" data-keyboard="false">
          <div class="modal-dialog" role="document" style="margin-top: 15px;margin-bottom: 0">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formStaffLabel">Update Worker Level</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              <div class="modal-footer">
                <button type="submit" class="btn btn-success" id="btnok">Update Worker Level</button>
                <button type="button" class="btn btn-light" data-dismiss="modal">Cancel</button>
              </div>
            </form>
            </div>
...
function add_worker(){
  //alert('ok');
      ...
      if(worker__name == "" ){
        ...
        $.ajax({
          url : "http://beta.xavaxx.com/new_worker",
                type: "POST",
                dataType: "JSON",
                data: {
...
function delItem(id){
  ...
  swal({
          ...
          $.ajax({
            url : "http://beta.xavaxx.com/deleted_worker",
                  type: "POST",
                  dataType: "JSON",
                  data: {
                    id : id
...
function edtItem(id){
  ...
  $.ajax({
      url : "http://beta.xavaxx.com/get_worker",
    type: "POST",
    dataType: "JSON",
    data: {
        id : id
...
function update_dep(id_dep){
  ...
  if(name == ""  ){
      ...
      //Memulai memasukan data ke database
    $.ajax({
      url : "http://beta.xavaxx.com/update_worker",
            type: "POST",
            dataType: "JSON",
            data: {
                name : name,
