...
<style type="text/css">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row mb-4">
            <div class="col-12 d-flex align-items-center justify-content-between">
              <h4 class="page-title">Birth Report</h4>
                ...
                <div class="card-body">
                  <div class="card-title row">
                    <div class="col-md-12 text-right">
                      <button class="btn btn-icons btn-inverse-success" id="buttonModal" data-toggle="modal" data-target="#formBirth"><i class="fa fa-plus"></i></button>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12 table-responsive">
                      <table id="tableBirth" class="table">
                        <thead>
                          <tr class="text-center">
                            ...
                            <th style="width: 20%">Date of Delivery</th>
        ...
        <div class="modal fade" id="formBirth" tabindex="-1" role="dialog" aria-labelledby="formBirthLabel" data-backdrop="static" data-keyboard="false">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formBirthLabel">Birth Report</h5>
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <div class="input-group date datepicker">
                                    <input type="text" id="date_of_delivery" name="date_of_delivery" class="form-control" >
        ...
        <div class="modal fade" id="detailStaff" tabindex="-1" role="dialog" aria-labelledby="formBirthLabel" data-backdrop="static" data-keyboard="false">
          <div class="modal-dialog modal-lg" role="document" style="margin-top: 15px;margin-bottom: 0">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formBirthLabel">Detail Staff</h5>
                <button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
