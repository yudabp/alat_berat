...
<style type="text/css">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row mb-4">
            <div class="col-12 d-flex align-items-center justify-content-between">
              <h4 class="page-title">Death Report</h4>
                ...
                <div class="card-body">
                  <div class="card-title row">
                    <div class="col-md-12 text-right">
                      <button class="btn btn-icons btn-inverse-success" id="buttonModal" data-toggle="modal" data-target="#formDeath"><i class="fa fa-plus"></i></button>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12 table-responsive">
                      <table id="tableDeath" class="table">
                        <thead>
                          <tr class="text-center">
                            ...
                            <th style="width: 20%">Date of Death</th>
        ...
        <div class="modal fade" id="formDeath" tabindex="-1" role="dialog" aria-labelledby="formDeathLabel" data-backdrop="static" data-keyboard="false">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formDeathLabel">Death Report</h5>
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <div class="input-group date datepicker">
                                    <input type="text" id="date_of_death" name="date_of_death" class="form-control" >
        ...
        <div class="modal fade" id="detailStaff" tabindex="-1" role="dialog" aria-labelledby="formDeathLabel" data-backdrop="static" data-keyboard="false">
          <div class="modal-dialog modal-lg" role="document" style="margin-top: 15px;margin-bottom: 0">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formDeathLabel">Detail Staff</h5>
                <button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
                              ...
                              <div class="col-md-12">
                                <table class="table">
                                  ...
                                  <tr>
                                    <td>Date of Death</td>
                                    <td>:</td>
                                    <td><span id="date_of_Deathd"></span></td>
                                  </tr>
                                  <tr>
                                    <td>Nationality</td>
                                    <td>:</td>
