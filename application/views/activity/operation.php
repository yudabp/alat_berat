...
<style type="text/css">
      ...
      <div class="main-panel">
                ...
                <div class="card-body">
                  <div class="card-title row">
                    <div class="col-md-12 text-right">
                      <button class="btn btn-icons btn-inverse-success" id="buttonModal" data-toggle="modal" data-target="#formOperation"><i class="fa fa-plus"></i></button>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12 table-responsive">
                      <table id="tableOperation" class="table">
                        <thead>
                          <tr class="text-center">
                            ...
                            <th style="width: 20%">Date of Operation</th>
        ...
        <div class="modal fade" id="formOperation" tabindex="-1" role="dialog" aria-labelledby="formOperationLabel" data-backdrop="static" data-keyboard="false">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formOperationLabel">Operation Report</h5>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <ul class="nav nav-tabs tab-basic" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" id="basic-tab" data-toggle="tab" href="#basic" role="tab">Add Report</a>
                          </li>
                        </ul>
                        <div class="tab-content tab-content-basic">
                          <div class="tab-pane fade show active" id="basic" role="tabpanel">
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <select name="patient" id="patient" class="single-select form-control" >
                                    <option selected="selected" disabled="disabled"> - Select Patient - </option>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                  <label for="date_of_operation">Date Of Delivery</label>
                                  <div class="input-group date datepicker">
                                    <input type="text" id="date_of_operation" name="date_of_operation" class="form-control" >
        ...
        <div class="modal fade" id="detailStaff" tabindex="-1" role="dialog" aria-labelledby="formOperationLabel" data-backdrop="static" data-keyboard="false">
          <div class="modal-dialog modal-lg" role="document" style="margin-top: 15px;margin-bottom: 0">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formOperationLabel">Detail Staff</h5>
                <button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
                              ...
                              <div class="col-md-12">
                                <table class="table">
                                  ...
                                  <tr>
                                    ...
                                    <td>:</td>
                                    <td><span id="date_of_Operationd"></span></td>
                                  </tr>
                                  <tr>
                                    <td>Nationality</td>
                                    <td>:</td>
